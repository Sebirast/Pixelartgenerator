...
<html>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <h3>A value:</h3>
                        <div class="slidercontainer">
                            <input id="aSlider" class="slider" type="range" min="0" max="255" value="255">
                            <h3 id="valueOfASlider" class="valueOfSlider">255</h3>
                        </div>
                    </div>
        ...
        <script src="Scripts/pixelartProcessing.js" type="module"></script>
